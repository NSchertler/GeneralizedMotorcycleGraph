...
public:
	...
	/// @param rects The list of rectangles to insert.
	/// @param dst [out] This list will contain the packed rectangles.
	/// @param method The rectangle placement rule to use when packing.
	bool Insert(std::vector<RectSize> &rects, std::vector<Rect> &dst, FreeRectChoiceHeuristic method);
